#!/usr/bin/env python2
#####################################################
# convert.py - Convert between ICAO numbers and Nxxxxx (tail) numbers for American planes (only, apparently)
#
#  FOUND THIS HERE: https://github.com/guillaumemichel/icao-nnumber_converter
#####################################################
import sys
