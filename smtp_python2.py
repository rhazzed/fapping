#!/usr/bin/env python2
############################################################
# smtp_python2.py - Send EMAIL via SMTP.
#
...
#  2020-10-20  msipin  Made python2 version from current python3 code.
############################################################

####################3
# EXAMPLE USAGE -
#   smtp_python2.py eric@whatever.com "This text here will be in the body of the email."
#   smtp_python2.py -a yahoo eric@whatever.com "This text here will be in the body of the email."
#   smtp_python2.py -a yahoo -s "This is the Subject" eric@whatever.com "This is the body of the email."
#   smtp_python2.py eric@whatever.com A b c d e f g the_end
#   smtp_python2.py -a gmail mike@youknowit.com `cat message.txt`
...
msg_subject = "PiAware Aircraft Alert" 
